...
const (
	BotService_ProcessUpdate_FullMethodName = "/bot.BotService/ProcessUpdate"
	BotService_SendMessage_FullMethodName   = "/bot.BotService/SendMessage"
)
...
func (c *botServiceClient) ProcessUpdate(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateResponse)
	err := c.cc.Invoke(ctx, BotService_ProcessUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBotServiceServer) ProcessUpdate(context.Context, *UpdateRequest) (*UpdateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessUpdate not implemented")
}
...
func _BotService_ProcessUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BotServiceServer).ProcessUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BotService_ProcessUpdate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServiceServer).ProcessUpdate(ctx, req.(*UpdateRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _BotService_ProcessUpdate_Handler,
		},
		{
